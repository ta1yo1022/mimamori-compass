  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <section className="bg-white py-10 px-5 sm:px-10 rounded-sm sm:w-auto sm:h-auto w-full h-full flex flex-col justify-start items-center">
        ...
        <p className="mt-5 text-gray-500 w-full sm:w-100 text-sm">サインインを完了することで、本システムの <span className="text-black">利用規約</span> および <span className="text-black">プライバシーポリシー</span> に同意したものとみなされます。</p>

        <Link href="/sign-up" className="mt-5 border-b border-black">アカウントをお持ちでない場合はこちら</Link>
